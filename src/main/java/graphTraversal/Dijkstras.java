...
//We're not at the goal node yet, so...
    ...
    public static <T> CostedPath findCheapestPathDijkstra(GraphNodeAL<?> startNode, T lookingFor, ArrayList<GraphNodeAL> avoidList) {
        ...
        if (avoidList.isEmpty()) {
            return findCheapestPathDijkstra(startNode, lookingFor);
        } else {
            do {
