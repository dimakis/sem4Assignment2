...
public class Dijkstras {
    public static <T> CostedPath findCheapestPathDijkstra(GraphNodeAL<?> startNode, T lookingfor, String modifier) {
...
//                    System.out.println("Before mod in 'not at goal yet': " + modifier + "\ne.Hist: " + e.historical + "\ne.easy: " + e.easiest);
    ...
    public static <T> CostedPath findCheapestPathDijkstra(GraphNodeAL<?> startNode, T lookingFor, ArrayList<GraphNodeAL> avoidList, String modifier) {
